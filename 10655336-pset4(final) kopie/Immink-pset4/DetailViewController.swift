...
class DetailViewController: UIViewController {
    ...
    // make string array to keep track of todo list
    ...
    // if view loads, setup databse and read table in
    ...
    // if button is clicked save to databse
    ...
    // delete note from table if note is deleted
